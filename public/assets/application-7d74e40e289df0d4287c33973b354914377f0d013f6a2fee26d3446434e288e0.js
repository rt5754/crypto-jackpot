...
(function() {
  ...
  App.jackpot = App.cable.subscriptions.create("JackpotChannel", {
    ...
    received: function(data) {
      ...
      return updateDonutChart('#jackpot-doughnut', data.pot.pot * 100, true);
    }
  });

  add_row = function(user, stake, winchance) {
    return $('#players-table-body').append('<tr>' + '<td>' + user.name + '</td>' + '<td>' + stake + '</td>' + '<td>' + winchance + '</td>');
  };

  updateDonutChart = function(el, percent, donut) {
    var deg;
